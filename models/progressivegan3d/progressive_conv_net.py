...
from .custom_layers import EqualizedConv3d, EqualizedLinear,\
    NormalizationLayer, Upscale3d
...
class GNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.groupScale0.append(EqualizedConv3d(depthScale0, depthScale0, 3,
                                                equalized=equalizedlR,
                                                initBiasToZero=initBiasToZero,
                                                padding=1))

        self.toRGBLayers.append(EqualizedConv3d(depthScale0, self.dimOutput, 1,
                                                equalized=equalizedlR,
                                                initBiasToZero=initBiasToZero))
    ...
    def addScale(self, depthNewScale):
        ...
        self.scaleLayers[-1].append(EqualizedConv3d(depthLastScale,
                                                    depthNewScale,
                                                    3,
                                                    padding=1,
                                                    equalized=self.equalizedlR,
                                                    initBiasToZero=self.initBiasToZero))
        self.scaleLayers[-1].append(EqualizedConv3d(depthNewScale, depthNewScale,
                                                    3, padding=1,
                                                    equalized=self.equalizedlR,
                                                    initBiasToZero=self.initBiasToZero))

        self.toRGBLayers.append(EqualizedConv3d(depthNewScale,
                                                self.dimOutput,
                                                1,
                                                equalized=self.equalizedlR,
                                                initBiasToZero=self.initBiasToZero))
...
class DNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.fromRGBLayers.append(EqualizedConv3d(dimInput, depthScale0, 1,
                                                  equalized=equalizedlR,
                                                  initBiasToZero=initBiasToZero))
        ...
        self.groupScaleZero.append(EqualizedConv3d(dimEntryScale0, depthScale0,
                                                   3, padding=1,
                                                   equalized=equalizedlR,
                                                   initBiasToZero=initBiasToZero))

        self.groupScaleZero.append(EqualizedLinear(depthScale0**4,
                                                   depthScale0,
                                                   equalized=equalizedlR,
                                                   initBiasToZero=initBiasToZero))
    ...
    def addScale(self, depthNewScale):
        ...
        self.scaleLayers[-1].append(EqualizedConv3d(depthNewScale,
                                                    depthNewScale,
                                                    3,
                                                    padding=1,
                                                    equalized=self.equalizedlR,
        ...
        self.fromRGBLayers.append(EqualizedConv3d(self.dimInput,
                                                  depthNewScale,
                                                  1,
                                                  equalized=self.equalizedlR,
                                                  initBiasToZero=self.initBiasToZero))
